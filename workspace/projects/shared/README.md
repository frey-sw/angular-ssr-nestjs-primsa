...
Run `ng generate component component-name --project shared` to generate a new component. You can also use `ng generate directive|pipe|service|class|guard|interface|enum|module --project shred`.
...
After building your library with `ng build shared`, go to the dist folder `cd dist/shred` and run `npm publish`.
